...
!function(e, t) {
    ...
    function o(e, t, n) {
        ...
        }) : Se.test(t) ? me.filter(t, e, n) : (t = me.filter(t, e),
    ...
    function m(e, t, n, r) {
        ...
        , l = s(), u = n && n[3] || (me.cssNumber[t] ? "" : "px"), c = (me.cssNumber[t] || "px" !== u && +l) && Re.exec(me.css(e, t));
        if (c && c[3] !== u) {
            u = u || c[3],
            n = n || [],
            c = +l || 1;
    ...
    function y(e, t) {
        ...
        void 0 === t || t && i(e, t) ? me.merge([e], n) : n
    }
    function x(e, t) {
    ...
    function b(e, t, n, r, i) {
        ...
        p = 0; o = d[p++]; )
            if (r && me.inArray(o, r) > -1)
                i && i.push(o);
            else if (u = me.contains(o.ownerDocument, o),
    ...
    function I(e, t, r, i) {
        t = oe.apply([], t);
        var o, a, s, l, u, c, f = 0, d = e.length, p = d - 1, h = t[0], m = me.isFunction(h);
        if (m || d > 1 && "string" == typeof h && !pe.checkClone && rt.test(h))
        ...
        a || i)) {
            for (s = me.map(y(o, "script"), E),
            l = s.length; d > f; f++)
                u = o,
                f !== p && (u = me.clone(u, !0, !0),
                l && me.merge(s, y(u, "script"))),
                r.call(e[f], u, f);
            if (l)
                ...
                f = 0; l > f; f++)
                    u = s[f],
                    Ye.test(u.type || "") && !He.access(u, "globalEval") && me.contains(c, u) && (u.src ? me._evalUrl && me._evalUrl(u.src) : n(u.textContent.replace(ot, ""), c))
        }
        return e
    }
    function D(e, t, n) {
        for (var r, i = t ? me.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
            ...
            r.parentNode && (n && me.contains(r.ownerDocument, r) && x(y(r, "script")),
    ...
    function L(e, t, n) {
        ...
        !pe.pixelMarginRight() && st.test(a) && at.test(t) && (r = s.width,
        i = s.minWidth,
        o = s.maxWidth,
    ...
    function q(e) {
        var t = me.cssProps[e];
        return t || (t = me.cssProps[e] = P(e) || e),
        t
    }
    function H(e, t, n) {
        var r = Re.exec(t);
    ...
    function F(e, t, n, r, i) {
        ...
        for (o = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0; 4 > o; o += 2)
            "margin" === n && (a += me.css(e, n + $e[o], !0, i)),
            r ? ("content" === n && (a -= me.css(e, "padding" + $e[o], !0, i)),
            "margin" !== n && (a -= me.css(e, "border" + $e[o] + "Width", !0, i))) : (a += me.css(e, "padding" + $e[o], !0, i),
            "padding" !== n && (a += me.css(e, "border" + $e[o] + "Width", !0, i)));
        return a
    }
    function M(e, t, n) {
        var r, i = lt(e), o = L(e, t, i), a = "border-box" === me.css(e, "boxSizing", !1, i);
        return st.test(o) ? o : (r = a && (pe.boxSizingReliable() || o === e.style[t]),
    ...
    function B() {
        gt && (ne.hidden === !1 && e.requestAnimationFrame ? e.requestAnimationFrame(B) : e.setTimeout(B, me.fx.interval),
        me.fx.tick())
    }
    function R() {
    ...
    function W(e, t, n) {
        var r, i, o, a, s, l, u, c, f = "width"in t || "height"in t, d = this, p = {}, h = e.style, m = e.nodeType && ze(e), g = He.get(e, "fxshow");
        n.queue || (a = me._queueHooks(e, "fx"),
        ...
        if (l = !me.isEmptyObject(t),
        l || !me.isEmptyObject(p)) {
            ...
            c = me.css(e, "display"),
            v([e]))),
            ("inline" === c || "inline-block" === c && null != u) && "none" === me.css(e, "float") && (l || (d.done(function() {
                h.display = u
            }),
            null == u && (c = h.display,
            u = "none" === c ? "" : c)),
            ...
            l = !1;
            for (r in p)
                l || (g ? "hidden"in g && (m = g.hidden) : g = He.access(e, "fxshow", {
                    display: u
                }),
                o && (g.hidden = !m),
                m && v([e], !0),
    ...
    function X(e, t, n) {
        var r, i, o = 0, a = X.prefilters.length, s = me.Deferred().always(function() {
            delete l.elem
        }), l = function() {
            if (i)
                return !1;
            for (var t = mt || R(), n = Math.max(0, u.startTime + u.duration - t), r = n / u.duration || 0, o = 1 - r, a = 0, l = u.tweens.length; l > a; a++)
                u.tweens[a].run(o);
            return s.notifyWith(e, [u, o, n]),
            1 > o && l ? n : (l || s.notifyWith(e, [u, 1, 0]),
            s.resolveWith(e, [u]),
            !1)
        }, u = s.promise({
            elem: e,
        ...
        for (U(c, u.opts.specialEasing); a > o; o++)
            if (r = X.prefilters[o].call(u, e, c, u.opts))
                return me.isFunction(r.stop) && (me._queueHooks(u.elem, u.opts.queue).stop = me.proxy(r.stop, r)),
                r;
        return me.map(c, z, u),
        ...
        s--); l > s; s++)
            if (null != (e = arguments[s]))
                for (t in e)
                    n = a[t],
                    r = e[t],
                    a !== r && (u && r && (me.isPlainObject(r) || (i = Array.isArray(r))) ? (i ? (i = !1,
                    o = n && Array.isArray(n) ? n : []) : o = n && me.isPlainObject(n) ? n : {},
                    a[t] = me.extend(u, o, r)) : void 0 !== r && (a[t] = r));
        return a
    }
    ,
    me.extend({
        ...
        makeArray: function(e, t) {
            var n = t || [];
            return null != e && (r(Object(e)) ? me.merge(n, "string" == typeof e ? [e] : e) : ae.call(n, e)),
            n
        },
        ...
        proxy: function(e, t) {
            ...
            t = e,
            e = n),
            me.isFunction(e) ? (r = ie.call(arguments, 2),
            i = function() {
    ...
    var be = function(e) {
        function t(e, t, n, r) {
            ...
            "string" != typeof e || !e || 1 !== h && 9 !== h && 11 !== h)
                return n;
            if (!r && ((t ? t.ownerDocument || t : R) !== O && L(t),
            t = t || O,
            q)) {
                if (11 !== h && (l = ve.exec(e)))
                    if (i = l[1]) {
                        if (9 === h) {
                            ...
                            if (a.id === i)
                                return n.push(a),
                                n
                        } else if (d && (a = d.getElementById(i)) && _(t, a) && a.id === i)
                            return n.push(a),
                            n
                    } else {
                        if (l[2])
                            ...
                            n;
                        if ((i = l[3]) && C.getElementsByClassName && t.getElementsByClassName)
                            return Q.apply(n, t.getElementsByClassName(i)),
                            n
                    }
                if (C.qsa && !X[e + " "] && (!H || !H.test(e))) {
                    if (1 !== h)
                        d = t,
                        c = e;
                    else if ("object" !== t.nodeName.toLowerCase()) {
                        for ((s = t.getAttribute("id")) ? s = s.replace(we, Ce) : t.setAttribute("id", s = B),
                        u = E(e),
                        o = u.length; o--; )
                            u[o] = "#" + s + " " + p(u[o]);
                        c = u.join(","),
                    ...
                    if (c)
                        try {
                            return Q.apply(n, d.querySelectorAll(c)),
                            n
                        } catch (m) {} finally {
        ...
        function y(e, t, n, i, o, a) {
            ...
            o && !o[B] && (o = y(o, a)),
            r(function(r, a, s, l) {
                var u, c, f, d = [], p = [], h = a.length, m = r || g(t || "*", s.nodeType ? [s] : s, []), y = !e || !r && t ? m : v(m, d, e, s, l), x = n ? o || (r ? e : h || i) ? [] : a : y;
                if (n && n(y, x, s, l),
                i)
                    for (u = v(x, p),
                    i(u, [], s, l),
                ...
                if (r) {
                    if (o || e) {
                        ...
                        for (c = x.length; c--; )
                            (f = x[c]) && (u = o ? ee(r, f) : d[c]) > -1 && (r[u] = !(a[u] = f))
                    }
                } else
                ...
                if (n = T.relative[e[s].type])
                    ...
                    n[B]) {
                        ...
                        return y(s > 1 && m(c), s > 1 && p(e.slice(0, s - 1).concat({
                            value: " " === e[s - 2].type ? "*" : ""
                        })).replace(se, "$1"), n, r > s && x(e.slice(s, r)), i > r && x(e = e.slice(r)), i > r && p(e))
                    }
                    c.push(n)
                }
            return m(c)
        ...
        function b(e, n) {
            var i = n.length > 0
              ...
              , a = function(r, a, s, l, u) {
                var c, f, d, p = 0, h = "0", m = r && [], g = [], y = A, x = r || o && T.find.TAG("*", u), b = $ += null == y ? 1 : Math.random() || .1, w = x.length;
                for (u && (A = a === O || a || u); h !== w && null != (c = x[h]); h++) {
                    if (o && c) {
                        for (f = 0,
                ...
                i && h !== p) {
                    ...
                    if (r) {
                        if (p > 0)
                            for (; h--; )
                                m[h] || g[h] || (g[h] = Z.call(l));
                        g = v(g)
                    }
                    Q.apply(l, g),
                    u && !r && g.length > 0 && p + n.length > 1 && t.uniqueSort(l)
                }
                return u && ($ = b,
                A = y),
                m
        ...
        var w, C, T, k, S, E, j, N, A, I, D, L, O, P, q, H, F, M, _, B = "sizzle" + 1 * new Date, R = e.document, $ = 0, z = 0, W = n(), U = n(), X = n(), V = function(e, t) {
            return e === t && (D = !0),
            0
        }, Y = {}.hasOwnProperty, G = [], Z = G.pop, K = G.push, Q = G.push, J = G.slice, ee = function(e, t) {
            for (var n = 0, r = e.length; r > n; n++)
                if (e[n] === t)
                    return n;
            return -1
        ...
        }, he = /^(?:input|select|textarea|button)$/i, me = /^h\d$/i, ge = /^[^{]+\{\s*\[native \w/, ve = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ye = /[+~]/, xe = new RegExp("\\\\([\\da-f]{1,6}" + ne + "?|(" + ne + ")|.)","ig"), be = function(e, t, n) {
            var r = "0x" + t - 65536;
        ...
        try {
            Q.apply(G = J.call(R.childNodes), R.childNodes),
        ...
        L = t.setDocument = function(e) {
            ...
            P = O.documentElement,
            q = !S(O),
            R !== O && (n = O.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", Te, !1) : n.attachEvent && n.attachEvent("onunload", Te)),
            ...
            C.getElementsByClassName = ge.test(O.getElementsByClassName),
            ...
            F = [],
            H = [],
            (C.qsa = ge.test(O.querySelectorAll)) && (i(function(e) {
            ...
            (C.matchesSelector = ge.test(M = P.matches || P.webkitMatchesSelector || P.mozMatchesSelector || P.oMatchesSelector || P.msMatchesSelector)) && i(function(e) {
            ...
            _ = t || ge.test(P.contains) ? function(e, t) {
            ...
            V = t ? function(e, t) {
                ...
                1 & n || !C.sortDetached && t.compareDocumentPosition(e) === n ? e === O || e.ownerDocument === R && _(R, e) ? -1 : t === O || t.ownerDocument === R && _(R, t) ? 1 : I ? ee(I, e) - ee(I, t) : 0 : 4 & n ? -1 : 1)
            }
            : function(e, t) {
                if (e === t)
                    return D = !0,
                ...
                if (!i || !o)
                    return e === O ? -1 : t === O ? 1 : i ? -1 : o ? 1 : I ? ee(I, e) - ee(I, t) : 0;
                if (i === o)
                    return a(e, t);
        ...
        t.matchesSelector = function(e, n) {
            ...
            n = n.replace(ce, "='$1']"),
            C.matchesSelector && q && !X[n + " "] && (!F || !F.test(n)) && (!H || !H.test(n)))
                try {
                    var r = M.call(e, n);
        ...
        T = t.selectors = {
            ...
            filter: {
                ...
                CHILD: function(e, t, n, r, i) {
                    ...
                    : function(t, n, l) {
                        var u, c, f, d, p, h, m = o !== a ? "nextSibling" : "previousSibling", g = t.parentNode, v = s && t.nodeName.toLowerCase(), y = !l && !s, x = !1;
                        if (g) {
                            if (o) {
                                for (; m; ) {
                                    for (d = t; d = d[m]; )
                            ...
                            a && y) {
                                ...
                                p = u[0] === $ && u[1],
                                x = p && u[2],
                                d = p && g.childNodes[p]; d = ++p && d && d[m] || (x = p = 0) || h.pop(); )
                            ...
                            x = p),
                            x === !1)
                                for (; (d = ++p && d && d[m] || (x = p = 0) || h.pop()) && ((s ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++x || (y && (f = d[B] || (d[B] = {}),
                                c = f[d.uniqueID] || (f[d.uniqueID] = {}),
                                c[e] = [$, x]),
                                d !== t)); )
                                    ;
        ...
        N = t.select = function(e, t, n, r) {
            var i, o, a, s, l, u = "function" == typeof e && e, c = !r && E(e = u.selector || e);
            if (n = n || [],
            1 === c.length) {
                if (o = c[0] = c[0].slice(0),
                o.length > 2 && "ID" === (a = o[0]).type && 9 === t.nodeType && q && T.relative[o[1].type]) {
                ...
                !T.relative[s = a.type]); )
                    if ((l = T.find[s]) && (r = l(a.matches[0].replace(xe, be), ye.test(o[0].type) && f(t.parentNode) || t))) {
                        if (o.splice(i, 1),
                        e = r.length && p(o),
                        !e)
                            return Q.apply(n, r),
            ...
            return (u || j(e, c))(r, t, !q, n, !t || ye.test(e) && f(t.parentNode) || t),
            n
        }
        ,
        C.sortStable = B.split("").sort(V).join("") === B,
    ...
    me.find = be,
    me.expr = be.selectors,
    me.expr[":"] = me.expr.pseudos,
    me.uniqueSort = me.unique = be.uniqueSort,
    me.text = be.getText,
    me.isXMLDoc = be.isXML,
    me.contains = be.contains,
    me.escapeSelector = be.escape;
    ...
    me.filter = function(e, t, n) {
        var r = t[0];
        return n && (e = ":not(" + e + ")"),
        1 === t.length && 1 === r.nodeType ? me.find.matchesSelector(r, e) ? [r] : [] : me.find.matches(e, me.grep(t, function(e) {
            return 1 === e.nodeType
        }))
    }
    ,
    ...
    var Ee, je = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/, Ne = me.fn.init = function(e, t, n) {
        var r, i;
        if (!e)
            return this;
        if (n = n || Ee,
        "string" == typeof e) {
            if (r = "<" === e[0] && ">" === e[e.length - 1] && e.length >= 3 ? [null, e, null] : je.exec(e),
            !r || !r[1] && t)
                return !t || t.jquery ? (t || n).find(e) : this.constructor(t).find(e);
            if (r[1]) {
                if (t = t instanceof me ? t[0] : t,
                me.merge(this, me.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : ne, !0)),
                ke.test(r[1]) && me.isPlainObject(t))
                    for (r in t)
        ...
        this.length = 1,
        this) : me.isFunction(e) ? void 0 !== n.ready ? n.ready(e) : e(me) : me.makeArray(e, this)
    }
    ;
    Ne.prototype = me.fn,
    Ee = me(ne);
    ...
    me.each({
        ...
        me.fn[e] = function(n, r) {
            ...
            this.length > 1 && (Ie[e] || me.uniqueSort(i),
            Ae.test(e) && i.reverse()),
            this.pushStack(i)
        }
    });
    ...
    me.extend({
                ...
                then: function(t, r, i) {
                    function o(t, n, r, i) {
                        return function() {
                            var s = this
                              ...
                              , f = function() {
                                ...
                                if (!(a > t)) {
                                    ...
                                    me.isFunction(f) ? i ? f.call(e, o(a, n, l, i), o(a, n, u, i)) : (a++,
                              ...
                              , d = i ? f : function() {
                                try {
                                    ...
                                    me.Deferred.exceptionHook && me.Deferred.exceptionHook(e, d.stackTrace),
                                    t + 1 >= a && (r !== u && (s = void 0,
                                    c = [e]),
                                    n.rejectWith(s, c))
                                }
                            ...
                            ;
                            t ? d() : (me.Deferred.getStackHook && (d.stackTrace = me.Deferred.getStackHook()),
                            e.setTimeout(d))
                        }
                    }
                    var a = 0;
        ...
        when: function(e) {
            ...
            if (1 >= t && (c(e, o.done(a(n)).resolve, o.reject, !t),
            "pending" === o.state() || me.isFunction(i[n] && i[n].then)))
                return o.then();
            for (; n--; )
                c(i[n], a(n), o.reject);
            return o.promise()
    ...
    me.extend({
        ...
        readyWait: 1,
        ready: function(e) {
            (e === !0 ? --me.readyWait : me.isReady) || (me.isReady = !0,
            e !== !0 && --me.readyWait > 0 || Oe.resolveWith(ne, [me]))
        }
    }),
    me.ready.then = Oe.then,
    "complete" === ne.readyState || "loading" !== ne.readyState && !ne.documentElement.doScroll ? e.setTimeout(me.ready) : (ne.addEventListener("DOMContentLoaded", f),
        ...
        data: function(e, t) {
            ...
            if (void 0 === e) {
                ...
                1 === o.nodeType && !He.get(o, "hasDataAttrs"))) {
                    for (n = a.length; n--; )
                        a[n] && (r = a[n].name,
                        0 === r.indexOf("data-") && (r = me.camelCase(r.slice(5)),
                        h(o, r, i[r])));
    ...
    me.extend({
        queue: function(e, t, n) {
            ...
            r = He.get(e, t),
            n && (!r || Array.isArray(n) ? r = He.access(e, t, me.makeArray(n)) : r.push(n)),
            r || []) : void 0
        },
    ...
    me.event = {
        ...
        add: function(e, t, n, r, i) {
            var o, a, s, l, u, c, f, d, p, h, m, g = He.get(e);
            if (g)
                for (n.handler && (o = n,
                n = o.handler,
                i = o.selector),
                i && me.find.matchesSelector(Ke, i),
        ...
        remove: function(e, t, n, r, i) {
            var o, a, s, l, u, c, f, d, p, h, m, g = He.hasData(e) && He.get(e);
            if (g && (l = g.events)) {
                for (t = (t || "").match(De) || [""],
                u = t.length; u--; )
                    if (s = et.exec(t[u]) || [],
                    ...
                    p) {
                        ...
                        a && !d.length && (f.teardown && f.teardown.call(e, h, g.handle) !== !1 || me.removeEvent(e, p, g.handle),
                        delete l[p])
                    } else
                        for (p in l)
        ...
        dispatch: function(e) {
            var t, n, r, i, o, a, s = me.event.fix(e), l = new Array(arguments.length), u = (He.get(this, "events") || {})[s.type] || [], c = me.event.special[s.type] || {};
            for (l[0] = s,
            t = 1; t < arguments.length; t++)
                l[t] = arguments[t];
            if (s.delegateTarget = this,
            !c.preDispatch || c.preDispatch.call(this, s) !== !1) {
                for (a = me.event.handlers.call(this, s, u),
                t = 0; (i = a[t++]) && !s.isPropagationStopped(); )
                    ...
                    n = 0; (o = i.handlers[n++]) && !s.isImmediatePropagationStopped(); )
                        ...
                        s.data = o.data,
                        r = ((me.event.special[o.origType] || {}).handle || o.handler).apply(i.elem, l),
        ...
        special: {
            ...
            click: {
                trigger: function() {
                    return "checkbox" === this.type && this.click && i(this, "input") ? (this.click(),
                    !1) : void 0
                },
                _default: function(e) {
                    return i(e.target, "a")
    ...
    me.Event = function(e, t) {
        ...
        this.type = e.type,
        this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && e.returnValue === !1 ? w : C,
    ...
    me.extend({
        ...
        clone: function(e, t, n) {
            var r, i, o, a, s = e.cloneNode(!0), l = me.contains(e.ownerDocument, e);
    ...
    me.each({
        ...
        me.fn[e] = function(e) {
            for (var n, r = [], i = me(e), o = i.length - 1, a = 0; o >= a; a++)
    ...
    me.each(["height", "width"], function(e, t) {
        me.cssHooks[t] = {
            get: function(e, n, r) {
                return n ? !ut.test(me.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? M(e, t, r) : We(e, ft, function() {
                    return M(e, t, r)
                }) : void 0
            },
            set: function(e, n, r) {
                var i, o = r && lt(e), a = r && F(e, t, r, "border-box" === me.css(e, "boxSizing", !1, o), o);
                return a && (i = Re.exec(n)) && "px" !== (i[3] || "px") && (e.style[t] = n,
                n = me.css(e, t)),
                H(e, n, a)
            }
        }
    ...
    me.cssHooks.marginLeft = O(pe.reliableMarginLeft, function(e, t) {
        return t ? (parseFloat(L(e, "marginLeft")) || e.getBoundingClientRect().left - We(e, {
            marginLeft: 0
        }, function() {
    ...
    me.each({
        ...
        at.test(e) || (me.cssHooks[e + t].set = H)
    }),
    me.fn.extend({
        css: function(e, t) {
    ...
    me.fx = _.prototype.init,
    me.fx.step = {};
    var mt, gt, vt = /^(?:toggle|show|hide)$/, yt = /queueHooks$/;
    ...
    me.fn.extend({
        ...
        finish: function(e) {
            return e !== !1 && (e = e || "fx"),
            this.each(function() {
                var t, n = He.get(this), r = n[e + "queue"], i = n[e + "queueHooks"], o = me.timers, a = r ? r.length : 0;
                for (n.finish = !0,
                me.queue(this, e, []),
    ...
    me.extend({
        attr: function(e, t, n) {
            ...
            return 3 !== o && 8 !== o && 2 !== o ? "undefined" == typeof e.getAttribute ? me.prop(e, t, n) : (1 === o && me.isXMLDoc(e) || (i = me.attrHooks[t.toLowerCase()] || (me.expr.match.bool.test(t) ? xt : void 0)),
            void 0 !== n ? null === n ? void me.removeAttr(e, t) : i && "set"in i && void 0 !== (r = i.set(e, n, t)) ? r : (e.setAttribute(t, n + ""),
    ...
    me.extend({
        prop: function(e, t, n) {
            var r, i, o = e.nodeType;
            return 3 !== o && 8 !== o && 2 !== o ? (1 === o && me.isXMLDoc(e) || (t = me.propFix[t] || t,
            i = me.propHooks[t]),
    ...
    me.fn.extend({
        val: function(e) {
            var t, n, r, i = this[0];
            return arguments.length ? (r = me.isFunction(e),
            this.each(function(n) {
                var i;
                1 === this.nodeType && (i = r ? e.call(this, n, me(this).val()) : e,
                null == i ? i = "" : "number" == typeof i ? i += "" : Array.isArray(i) && (i = me.map(i, function(e) {
                    return null == e ? "" : e + ""
                })),
                t = me.valHooks[this.type] || me.valHooks[this.nodeName.toLowerCase()],
                t && "set"in t && void 0 !== t.set(this, i, "value") || (this.value = i))
            })) : i ? (t = me.valHooks[i.type] || me.valHooks[i.nodeName.toLowerCase()],
            t && "get"in t && void 0 !== (n = t.get(i, "value")) ? n : (n = i.value,
            "string" == typeof n ? n.replace(Tt, "") : null == n ? "" : n)) : void 0
        }
    }),
    me.extend({
        valHooks: {
    ...
    me.extend(me.event, {
        trigger: function(t, n, r, i) {
            var o, a, s, l, u, c, f, d = [r || ne], p = ce.call(t, "type") ? t.type : t, h = ce.call(t, "namespace") ? t.namespace.split(".") : [];
            if (a = s = r = r || ne,
            3 !== r.nodeType && 8 !== r.nodeType && !kt.test(p + me.event.triggered) && (p.indexOf(".") > -1 && (h = p.split("."),
            p = h.shift(),
            h.sort()),
            u = p.indexOf(":") < 0 && "on" + p,
            ...
            i || !f.trigger || f.trigger.apply(r, n) !== !1)) {
                if (!i && !f.noBubble && !me.isWindow(r)) {
                    ...
                    kt.test(l + p) || (a = a.parentNode); a; a = a.parentNode)
                        d.push(a),
                        s = a;
                ...
                return t.type = p,
                i || t.isDefaultPrevented() || f._default && f._default.apply(d.pop(), n) !== !1 || !qe(r) || u && me.isFunction(r[p]) && !me.isWindow(r) && (s = r[u],
                s && (r[u] = null),
    ...
    me.fn.extend({
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !me(this).is(":disabled") && Dt.test(this.nodeName) && !It.test(e) && (this.checked || !Xe.test(e))
            }).map(function(e, t) {
                var n = me(this).val();
    ...
    me.extend({
        ...
        ajax: function(t, n) {
            function r(t, n, r, s) {
                ...
                r && (b = J(h, T, r)),
                b = ee(h, b, T, u),
                u ? (h.ifModified && (w = T.getResponseHeader("Last-Modified"),
                w && (me.lastModified[o] = w),
                ...
                T.status = t,
                T.statusText = (n || C) + "",
                u ? v.resolveWith(m, [d, C, T]) : v.rejectWith(m, [T, C, p]),
                T.statusCode(x),
                x = void 0,
                f && g.trigger(u ? "ajaxSuccess" : "ajaxError", [T, h, u ? d : p]),
                y.fireWith(m, [T, C]),
                f && (g.trigger("ajaxComplete", [T, h]),
                --me.active || me.event.trigger("ajaxStop")))
            }
            "object" == typeof t && (n = t,
            t = void 0),
            n = n || {};
            var i, o, a, s, l, u, c, f, d, p, h = me.ajaxSetup({}, n), m = h.context || h, g = h.context && (m.nodeType || m.jquery) ? me(m) : me.event, v = me.Deferred(), y = me.Callbacks("once memory"), x = h.statusCode || {}, b = {}, w = {}, C = "canceled", T = {
                readyState: 0,
            ...
            null == h.crossDomain) {
                ...
                try {
                    u.href = h.url,
                    u.href = u.href,
                    h.crossDomain = $t.protocol + "//" + $t.host != u.protocol + "//" + u.host
                } catch (k) {
                    h.crossDomain = !0
                }
            }
            ...
            h.data && (o += (jt.test(o) ? "&" : "?") + h.data,
            delete h.data),
            h.cache === !1 && (o = o.replace(Pt, "$1"),
            p = (jt.test(o) ? "&" : "?") + "_=" + Et++ + p),
            h.url = o + p),
            h.ifModified && (me.lastModified[o] && T.setRequestHeader("If-Modified-Since", me.lastModified[o]),
            me.etag[o] && T.setRequestHeader("If-None-Match", me.etag[o])),
    ...
    me.ajaxTransport(function(t) {
        var n, r;
        return pe.cors || Wt && !t.crossDomain ? {
            send: function(i, o) {
                var a, s = t.xhr();
    ...
    me.ajaxPrefilter("json jsonp", function(t, n, r) {
        ...
        return s || "jsonp" === t.dataTypes[0] ? (i = t.jsonpCallback = me.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback,
        s ? t[s] = t[s].replace(Xt, "$1" + i) : t.jsonp !== !1 && (t.url += (jt.test(t.url) ? "&" : "?") + t.jsonp + "=" + i),
    ...
    me.offset = {
        setOffset: function(e, t, n) {
            var r, i, o, a, s, l, u, c = me.css(e, "position"), f = me(e), d = {};
    ...
    me.each(["top", "left"], function(e, t) {
        me.cssHooks[t] = O(pe.pixelPosition, function(e, n) {
            return n ? (n = L(e, t),
            st.test(n) ? me(e).position()[t] + "px" : n) : void 0
        })
    }),
    me.each({
        Height: "height",
        ...
        me.each({
            ...
            me.fn[r] = function(i, o) {
                ...
                return Pe(this, function(t, n, i) {
                    ...
                    Math.max(t.body["scroll" + e], o["scroll" + e], t.body["offset" + e], o["offset" + e], o["client" + e])) : void 0 === i ? me.css(t, n, s) : me.style(t, n, i, s)
                }, t, a ? i : void 0, a)
            }
        })
    }),
...
function(e) {
    ...
    e.fn.fitVids = function(t) {
        ...
        if (!document.getElementById("fit-vids-style")) {
            ...
            o.innerHTML = '<p>x</p><style id="fit-vids-style">' + i + "</style>",
            r.appendChild(o.childNodes[1])
        }
...
$(document).ready(function() {
    function e() {
        ...
        u = n.children().length,
        c = s[u - 1],
        c > l ? (n.children().last().prependTo(r),
        u -= 1,
        e()) : l > s[u] && (r.children().first().appendTo(n),
        u += 1,
        e()),
        t.attr("count", i - u),
        u === i ? t.addClass("hidden") : t.removeClass("hidden")
    }
...
function(e) {
    ...
    var t, n, r, i, o, a, s = "Close", l = "BeforeClose", u = "AfterClose", c = "BeforeAppend", f = "MarkupParse", d = "Open", p = "Change", h = "mfp", m = "." + h, g = "mfp-ready", v = "mfp-removing", y = "mfp-prevent-close", x = function() {}, b = !!window.jQuery, w = e(window), C = function(e, n) {
        t.ev.on(h + e + m, n)
    }, T = function(t, n, r, i) {
        var o = document.createElement("div");
        return o.className = "mfp-" + t,
        r && (o.innerHTML = r),
        i ? n && n.appendChild(o) : (o = e(o),
        n && o.appendTo(n)),
        o
    }, k = function(n, r) {
    ...
    x.prototype = {
        ...
        open: function(n) {
            ...
            k("BeforeOpen"),
            t.st.showCloseBtn && (t.st.closeBtnInside ? (C(f, function(e, t, n, r) {
        ...
        updateItemHTML: function() {
            ...
            var r = n.type;
            if (k("BeforeChange", [t.currItem ? t.currItem.type : "", r]),
            t.currItem = n,
            !t.currTemplate[r]) {
                var o = t.st[r] ? t.st[r].markup : !1;
                k("FirstMarkupParse", o),
                o ? t.currTemplate[r] = e(o) : t.currTemplate[r] = !0
            }
        ...
        parseEl: function(n) {
            ...
            return i.type = r || t.st.type || "inline",
            i.index = n,
            i.parsed = !0,
            t.items[n] = i,
            k("ElementParse", i),
        ...
        addGroup: function(e, n) {
            ...
            n.mainEl = e,
            n.items ? (n.isObj = !0,
            e.off(i).on(i, r)) : (n.isObj = !1,
            n.delegate ? e.off(i).on(i, n.delegate, r) : (n.items = e,
            e.off(i).on(i, r)))
        },
    ...
    e.fn.magnificPopup = function(n) {
        ...
        if ("string" == typeof n)
            if ("open" === n) {
                var i, o = b ? r.data("magnificPopup") : r[0].magnificPopup, a = parseInt(arguments[1], 10) || 0;
            ...
            n = e.extend(!0, {}, n),
            b ? r.data("magnificPopup", n) : r[0].magnificPopup = n,
            t.addGroup(r, n);
        return r
    }
    ;
    var N, A, I, D = "inline", L = function() {
        I && (A.after(I.addClass(N)).detach(),
        I = null)
    };
            ...
            getInline: function(n, r) {
                ...
                n.src) {
                    ...
                    if (o.length) {
                        ...
                        a && a.tagName && (A || (N = i.hiddenClass,
                        A = T(N),
                        N = "mfp-" + N),
                        I = o.after(A).detach().removeClass(N)),
                ...
                var n = 0
                  ...
                  , i = function(o) {
                    ...
                    F = setInterval(function() {
                        return r.naturalWidth > 0 ? void t._onImageHasSize(e) : (n > 200 && clearInterval(F),
                        n++,
        ...
        proto: {
            initZoom: function() {
                ...
                if (n.enabled && t.supportsTransition) {
                    var i, o, a = n.duration, u = function(e) {
            ...
            _getOffset: function(n) {
                ...
                return B() ? s["-moz-transform"] = s.transform = "translate(" + i.left + "px," + i.top + "px)" : (s.left = i.left,
                s.top = i.top),
                s
            }
        }
    ...
    e.magnificPopup.registerModule("gallery", {
        ...
        proto: {
            ...
            preloadNearbyImages: function() {
                var e, n = t.st.gallery.preload, r = Math.min(n[0], t.items.length), i = Math.min(n[1], t.items.length);
            ...
            initRetina: function() {
                if (window.devicePixelRatio > 1) {
                    var e = t.st.retina
                      , n = e.ratio;
                    n = isNaN(n) ? n() : n,
                    n > 1 && (C("ImageHasSize." + X, function(e, t) {
                        t.img.css({
...
!function(e) {
    ...
    var t = {}
      ...
      , r = function(t) {
        ...
        return this.each(function() {
            var t = e(this);
            return this !== document && this !== window ? !document.scrollingElement || this !== document.documentElement && this !== document.body ? void (t[i]() > 0 ? n.push(this) : (t[i](1),
            r = t[i]() > 0,
            r && n.push(this),
            t[i](0))) : (n.push(document.scrollingElement),
            !1) : void 0
        }),
    ...
    e.fn.extend({
        ...
        smoothScroll: function(t, n) {
              ...
              , i = function(t) {
                ...
                a.scrollTarget || m && g && v) {
                    for (; f && u < s.length; )
                        o.is(n(s[u++])) && (f = !1);
                    for (; f && c < l.length; )
                        o.closest(l[c++]).length && (f = !1)
                } else
                    f = !1;
                f && (a.preventDefault && t.preventDefault(),
                e.extend(d, a, {
            ...
            return null !== t.delegateSelector ? this.off("click.smoothscroll", t.delegateSelector).on("click.smoothscroll", t.delegateSelector, i) : this.off("click.smoothscroll").on("click.smoothscroll", i),
            this
        }
    });
    var o = function(e) {
      ...
      , a = function(t) {
        ...
        t.autoFocus && n.length && (n[0].focus(),
        n.is(document.activeElement) || (n.prop({
            tabIndex: -1
        }),
        n[0].focus())),
    ...
    e.smoothScroll = function(n, r) {
        if ("options" === n && "object" == typeof r)
            return e.extend(t, r);
        var i, s, l, u, c = o(n), f = {}, d = 0, p = "offset", h = "scrollTop", m = {}, g = {};
        c.px ? i = e.extend({
            link: null
        }, e.fn.smoothScroll.defaults, t) : (i = e.extend({
            link: null
        }, e.fn.smoothScroll.defaults, n || {}, t),
        i.scrollElement && (p = "position",
        "static" === i.scrollElement.css("position") && i.scrollElement.css("position", "relative")),
        r && (c = o(r))),
        h = "left" === i.direction ? "scrollLeft" : h,
        i.scrollElement ? (s = i.scrollElement,
        c.px || /^(?:HTML|BODY)$/.test(s[0].nodeName) || (d = s[h]())) : s = e("html, body").firstScrollable(i.direction),
        i.beforeScroll.call(s, i),
        f = c.px ? c : {
            relative: "",
            px: e(i.scrollTarget)[p]() && e(i.scrollTarget)[p]()[i.direction] || 0
        },
        m[h] = f.relative + (f.px + d + i.offset),
        l = i.speed,
        "auto" === l && (u = Math.abs(m[h] - s[h]()),
        l = u / i.autoCoefficient),
        g = {
            duration: l,
            easing: i.easing,
            complete: function() {
        ...
        i.step && (g.step = i.step),
        s.length ? s.stop().animate(m, g) : a(i)
    }
    ,
